...
public class activity_dashboard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newdnewaccount.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(activity_dashboard.this, RegistrationActivity.class));
            }
        });
        ...
        mAuth.sendPasswordResetEmail(emaill).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if (task.isSuccessful()) {
                    Toast.makeText(activity_dashboard.this, "Done sent", Toast.LENGTH_LONG).show();
                } else {
                    Toast.makeText(activity_dashboard.this, "Error Occurred", Toast.LENGTH_LONG).show();
                }
            }
            ...
            public void onFailure(@NonNull Exception e) {
                loadingBar.dismiss();
                Toast.makeText(activity_dashboard.this, "Error Failed", Toast.LENGTH_LONG).show();
            }
        });
    }
        ...
        mAuth.signInWithEmailAndPassword(emaill, pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(activity_dashboard.this, "Registered User " + user.getEmail(), Toast.LENGTH_LONG).show();
                    Intent mainIntent = new Intent(activity_dashboard.this, DashboardActivity.class);
                    mainIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                    startActivity(mainIntent);
                    finish();
                } else {
                    loadingBar.dismiss();
                    Toast.makeText(activity_dashboard.this, "Login Failed", Toast.LENGTH_LONG).show();
                }
            }
        }).addOnFailureListener(new OnFailureListener() {
            @Override
